...
class CartBottom extends StatelessWidget {
  ...
  Widget selectAllBtn(context) {
    return Container(
      child: Row(
        children: <Widget>[
          Checkbox(
            value: Provider.of<CartProvider>(context).allIsCheck,
            activeColor: Colors.pink,
            onChanged: (bool val) {
              Provider.of<CartProvider>(context).changeAllIsCheck(val);
            },
          ),
          Text('全选')
        ],
          ...
          Row(
            children: <Widget>[
              ...
              Container(
                ...
                width: ScreenUtil().setWidth(215),
                child: Text(
                    '￥${Provider.of<CartProvider>(context).totalMoney.toStringAsFixed(1)}',
                    style: TextStyle(
  ...
  Widget goButton(context) {
    var tempTotalCount = Provider.of<CartProvider>(context).totalCount;
    return Container(
